exports.creds = {
    // Required
    identityMetadata: 'https://login.microsoftonline.com/progressmfg.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
    ...
    // Required, the client/application ID of your app in AAD  
    ...
    clientSecret: 'ojHPND38%=akjzeWND630?{', 
